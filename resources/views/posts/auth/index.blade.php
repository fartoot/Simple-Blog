<x-app-layout>
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all the Posts in your account including their name, title,
                email and role.</p>
        </div>
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col"
                        ...
                        at</th>
                    <th scope="col"
                        class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Role</th>
                ...
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 lg:table-cell">
                            {{ $post->updated_at }}</td>
                        <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 lg:table-cell">Admin</td>
                        <td
