    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div role="list"
            ...
            @foreach ($categories as $key => $category)
                <div class="relative">
                    <a href="/category/{{ $category->slug }}" class="flex flex-col ">
                        <img class="aspect-[3/3] w-full rounded-full object-cover hover:scale-105 hover:transition-all brightness-50"
